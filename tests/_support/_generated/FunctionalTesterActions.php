<?php  //[STAMP] f04ed2a6cd11fed087bcd7560622e460
...
trait FunctionalTesterActions
{
    ...
    public function bootstrapPartner($ID, $Password, $Source, $Campaign) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('bootstrapPartner', func_get_args()));
    }
    ...
    public function bootstrapSoapGateway($partner, $wsdl) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('bootstrapSoapGateway', func_get_args()));
    }
    ...
    public function getNetworkForGoodInterface() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getNetworkForGoodInterface', func_get_args()));
    }
    ...
    public function makeDonationTransactionWithIds() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('makeDonationTransactionWithIds', func_get_args()));
    }
}